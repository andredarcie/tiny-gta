...
// to their .ts sources). The game reads world.json at build/boot and never re-rolls
// anything. Re-run this only when you want to regenerate from the seed; to hand-tweak
// the map, edit world.json directly (a future editor will write it too).
