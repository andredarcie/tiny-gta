...
function lerpC(a,b,t){return _ca.copy(a).lerp(b,clamp(t,0,1));}
...
function coastRing(inExtra,outExtra,seg=120){
...
function buildRock(scale,mossy){
...
function addRockAt(x,y,z,scale,mossy){
...
function buildDock(x0,z0,dirx,dirz,len){
  const g=new THREE.Group();
...
export function buildIslandParadise(solids){
  buildTerrain();
