...
function pointedWindow(w: number,h: number): THREE.Group {
...
export function addChurch(cx: number,cz: number,ry=0): {x0:number;x1:number;z0:number;z1:number;h:number} {
