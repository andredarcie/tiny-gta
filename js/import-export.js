...
import {state,refs,carNames} from './state.js';
import {economy} from './economy.js';
import {scene} from './engine.js';
import {playerPos,cur,idleCars} from './player.js';
import {message,bigText,hideBig} from './hud.js';
import {blip} from './audio.js';
import {N,nodeX,pick,irand,clamp,groundHeight} from './constants.js';
...
let job=null;              // {car,total,match,phase,t} ou null
...
const puffs=[]; // animacoes de poeira ativas (avancadas no update)
...
export function updateImportExport(dt){
  t+=dt;
