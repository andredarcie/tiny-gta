...
export function makeStoryBeacon(color: number): THREE.Mesh{
...
export default {category:'Missions',label:'Story beacon',build:(o:{color?:number})=>makeStoryBeacon(o.color??0x19e3ff)};
