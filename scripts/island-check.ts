// Verificação ASCII da costa da ilha (node puro, sem browser; rodar via tsx).
...
const onIsland=(x: number,z: number)=>{const dx=x-ISLAND_CX,dz=z-ISLAND_CZ;
...
const land: [string, number, number, boolean][]=[
