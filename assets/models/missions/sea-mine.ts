...
function build(opts: {radius?:number}={}): THREE.Group{
  ...
  function horn(theta: number,phi: number): void{ // theta: angle from +Y, phi: azimuth
...
export function makeSeaMine(opts: {radius?:number}): THREE.Group{return build(opts);}
