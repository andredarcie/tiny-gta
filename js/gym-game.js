...
function flash(t,c){flashText=t;flashColor=c;flashT=FLASH_DUR;}
...
export function updateGymGame(dt){
  if(!active)return false;
  ensureSize();frameCamera();
...
function drawActive(panelX,panelW){
  // POWER BAR (timing)
...
$('gym-game-exit')?.addEventListener('pointerdown',e=>{
