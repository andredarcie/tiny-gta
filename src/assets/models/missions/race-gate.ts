...
export function makeRaceGate(color=0xff8a1e): THREE.Group{
...
export default {category:'Missions',label:'Race gate',build:(o:{color?:number})=>makeRaceGate(o.color??0xff8a1e)};
