...
import {clamp,wrapA,rand,irand,SWIM_BOUND,isLand} from './constants.js';
import {state,refs} from './state.js';
import {scene} from './engine.js';
import {makeBoat,makePed,attachHandGun,blinkBar,disposeGeometries} from './entities.js';
import {makeGangTracerLine} from '../assets/models/effects/gang-tracer.js';
import {thud,gunshot} from './audio.js';
import {message} from './hud.js';
import {playerPos,cur,inWater,getWasted} from './player.js';
...
export const policeBoats=[]; // {g,heading,speed,bobT,shootT,captain,ramT}
const tracers=[];            // rastros de tiro {line,t}
...
function removePoliceBoat(b){scene.remove(b.g);}
...
export function updatePoliceBoats(dt){
  const pp=playerPos();
