...
import {rand,groundHeight,MOUNT_X,MOUNT_H,MOUNT_S,MOUNT_SEG} from '@/core/constants.ts';
...
export default {category:'Terrain',label:'Mountain',build:(o: {size?: number; segments?: number})=>makeMountain(o.size??MOUNT_S,o.segments??MOUNT_SEG)};
