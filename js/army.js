...
let truck=null;           // {g,heading,speed,stuckT,backT,dentT,deployed,allDeadAt,bestDist,noProgressT}
...
function spawnArmy(){
  ...
  for(let i=0;i<4;i++){
    ...
    o.g.traverse(m=>{if(m.isMesh)m.castShadow=false;}); // squad casts no shadow (cost)
