...
export const tunnelFx={gateGlow:null,buttonGlow:null,bulbs:[]};

{
  ...
  const add=(geo,m,x,y,z,fn)=>{const o=new THREE.Mesh(geo,m);o.position.set(x,y,z);if(fn)fn(o);g.add(o);return o;};
