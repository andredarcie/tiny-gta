...
function buildBuoy(color=0xff8a1e){
...
export function makeBuoy(color=0xff8a1e){
...
export default {category:'Missions',label:'Race buoy',build:o=>buildBuoy(o?.color??0xff8a1e)};
