...
const cruiser={g:makeCar(0xe8e8ee,true),heading:0,speed:0,
...
refs.isVigilanteCar=c=>c===cruiser;
...
function registerHit(){
  const cp=cruiser.g.position,xp=criminal.g.position;
  criminal.lastHit=state.time;
