...
function plantSmall(t:string,x:number,z:number){
...
const FARMHOUSES:[number,number,number][]=[[212,-12,0],[236,10,-.4],[258,12,.3],[282,-12,.2],[302,10,-.25],
  [222,74,2.8],[310,-58,1.3]].map(([x,z,r]):[number,number,number]=>[x+RURAL_GAP,z,r]);
...
export function updateBeach(time:number){updateCoastFoam(coastFoam,time);updateIslandFoam(islandFoam,time);}
