...
export function addNightclub(solids:{x0:number,x1:number,z0:number,z1:number,h:number}[]):void{
  ...
  for(const[y,m]of[[3.4,neonCyanM],[1.1,neonPinkM]] as [number,THREE.MeshBasicMaterial][]){
