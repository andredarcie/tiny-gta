...
function makeMarkTex(mirror,w,h){
...
function buildAmbulance(){
  ...
  g.traverse(o=>{if(o.isMesh&&o.renderOrder===3)o.visible=false;});

  // 3) lanternas pro fundo do módulo (mantém userData.tailM = luz de freio)
  g.traverse(o=>{if(o.isMesh&&o.material===g.userData.tailM)o.position.set(0,.34,.15);});
...
export function makeAmbulance(){const g=buildAmbulance();scene.add(g);return g;}
